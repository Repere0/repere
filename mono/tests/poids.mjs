...
await page.getByLabel(/Votre département/).fill("seine saint");
await page.getByRole("button",{name:/^93 /}).click();
await page.getByLabel(/Votre commune/).fill("Bagnolet");
await page.getByRole("button",{name:"Bagnolet",exact:true}).click();
...
console.log("+ choix commune (93, Bagnolet)  :",ko(apresCommune-apresOuverture),"  cumul",ko(apresCommune));
